...
- `src/extract_dvcs_cff/cli/user.py`: configurable workspace/database roots, recorded scheduler environment overrides, and public `./dvcs` command hints;
...
- `user/*.md`: replace the development launcher path with the public root launcher (packaging-owned).
